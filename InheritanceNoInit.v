...
Proof.
  ...
  try destruct _str_eq_dec; try invc_noinit; auto using no_init.
Qed.
...
Local Ltac solve_noinit_inheritance :=
  ...
  auto using noinit_from_value, noinit_inheritance_subst, no_init.
...
Lemma noinit_inheritance_insert : forall ad t1 t2 ad' t' T',
  valid_blocks t1 ->
  (* --- *)
  ad <> ad' ->
  no_init ad t2 ->
...
Lemma noinit_inheritance_write : forall ad t1 t2 ad' t',
  valid_blocks t1 ->
  (* --- *)
  no_init ad t2 ->
  t1 --[e_write ad' t']--> t2 ->
...
Lemma noinit_inheritance_acq : forall ad t1 t2 ad' t',
  valid_blocks t1 ->
  (* --- *)
  no_init ad t2 ->
  t1 --[e_acq ad' t']--> t2 ->
...
Lemma noinit_inheritance_spawn : forall ad t1 t2 tid t,
  valid_blocks t1 ->
  (* --- *)
  no_init ad t2 ->
  t1 --[e_spawn tid t]--> t2 ->
