...
Proof.
  ...
  do 3 simpl_array.
  - intros Huacc.
    destruct (access_dec m ths[tid2] ad) as [Hacc2 | Hnacc2].
    ...
    + assert (Hacc1' : access m ths[tid1] ad')
      ...
      assert (Hacc2' : access m ths[tid2] ad')
        by eauto using mem_set_inherits_acc2.
...
Lemma contains_nuacc : forall m t t' ad,
  ~ UnsafeAccess m t ad ->
  t contains t' ->
  ~ UnsafeAccess m t' ad.
Proof.
