...
Inductive safe_boundaries : tm -> Prop :=
  ...
  | sb_newR   : forall t T,     safe_boundaries t  ->
                                safe_boundaries <{new t : r&T  }>
  | sb_newX   : forall t T,     no_wrefs t         ->
                                safe_boundaries t  ->
                                safe_boundaries <{new t : x&T  }>
  | sb_newW   : forall t T,     safe_boundaries t  ->
                                safe_boundaries <{new t : w&T  }>
  | sb_init  : forall ad t T,   safe_boundaries t  ->
                                safe_boundaries <{init ad t : T}>
...
Local Ltac _sb tt :=
  ...
  | H : safe_boundaries <{init _ _ : _}>   |- _ => tt H
