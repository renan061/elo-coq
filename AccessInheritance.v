...
Corollary acc_insert_contradiction : forall m ths tid t ad te,
  forall_threads ths (consistent_inits m) ->
  no_uninitialized_references m ths ->
  (* --- *)
  ths[tid] --[e_insert ad te]--> t ->
...
Proof.
  ...
  try destruct str_eq_dec; try invc_acc; auto using access;
  aspecialize; repeat invc_acc; auto using access.
Qed.
...
Lemma acc_inheritance_insert : forall ad ad' t t1 t2,
  ad <> ad' ->
  access ad t2 ->
  t1 --[e_insert ad' t]--> t2 ->
  access ad t1.
...
Lemma xacc_inheritance_insert : forall m adx ad ad' t' t1 t2,
...
Proof.
  ...
  - repeat aspecialize. constructor. admit.
