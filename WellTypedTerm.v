...
Ltac invc_wtt :=
  ...
  | H : wtt <{_ + _       }> |- _ => eapply inv_wtt_plus  in H as [? ?]
  | H : wtt <{_ - _       }> |- _ => eapply inv_wtt_monus in H as [? ?]
