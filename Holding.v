...
From Elo Require Import InheritanceNoReacq.
...
Corollary hg_inheritance_none : forall ad m t1 t2,
  valid_term m t1 ->
  (* --- *)
  holding ad t2       ->
  t1 --[e_none]--> t2 ->
...
Corollary hg_inheritance_alloc : forall ad m t1 t2 ad' T',
  valid_term m t1 ->
  (* --- *)
  holding ad t2               ->
  t1 --[e_alloc ad' T']--> t2 ->
...
Corollary hg_inheritance_init : forall ad m t1 t2 ad' t',
  valid_term m t1 ->
  (* --- *)
  holding ad t2              ->
  t1 --[e_init ad' t']--> t2 ->
...
Corollary hg_inheritance_read : forall ad m t1 t2 ad' t',
  value t'        ->
  valid_term m t' ->
  (* --- *)
  holding ad t2              ->
...
Corollary hg_inheritance_write : forall ad m t1 t2 ad' t',
  valid_term m t1 ->
  (* --- *)
  holding ad t2               ->
  t1 --[e_write ad' t']--> t2 ->
...
Corollary hg_inheritance_acq : forall ad m t1 t2 ad' t',
  value t'        ->
  valid_term m t' ->
  valid_term m t1 ->
  (* --- *)
...
Corollary hg_inheritance_rel : forall ad t1 t2 ad',
  ad <> ad'              ->
  holding ad t2          ->
  t1 --[e_rel ad']--> t2 ->
  holding ad t1.
...
Corollary hg_inheritance_wacq : forall ad t1 t2 ad',
  ad <> ad'               ->
  holding ad t2           ->
  t1 --[e_wacq ad']--> t2 ->
  holding ad t1.
...
Corollary hg_inheritance_wrel : forall ad t1 t2 ad',
  holding ad t2 ->
  t1 --[e_wrel ad']--> t2 ->
  holding ad t1.
Proof.
...
Corollary hg_inheritance_spawn : forall ad m t1 t2 t',
  valid_term m t1 ->
  (* --- *)
  holding ad t2           ->
  t1 --[e_spawn t']--> t2 ->
...
Corollary hg_inheritance_spawned : forall ad m t1 t2 t',
  valid_term m t1 ->
  (* --- *)
  holding ad t'           ->
  t1 --[e_spawn t']--> t2 ->
